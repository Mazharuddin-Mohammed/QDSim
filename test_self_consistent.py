...
# Import the modules in a specific order to avoid conflicts
from qdsim.qdsim_cpp import MaterialDatabase, SelfConsistentSolver
# Import Mesh separately to avoid conflicts
from qdsim.qdsim_cpp import Mesh
...
def main():
    ...
    sc_solver = SelfConsistentSolver(mesh, epsilon_r, rho, n_conc, p_conc, mu_n, mu_p)
