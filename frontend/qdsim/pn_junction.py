...
class PNJunction:
    ...
    def potential(self, x, y):
        ...
        accurate model that smoothly transitions between the p and n regions.
        ...
        if d < -self.W_p:
            ...
            # Inside depletion region - smooth transition
            if d < 0:
                # P-side depletion region
                # Quadratic potential profile in depletion region
                V = -self.V_total * (self.W_p + d)**2 / self.W_p**2
            else:
                # N-side depletion region
                # Linear potential profile in depletion region
                V = -self.V_total * (1 - d / self.W_n)
