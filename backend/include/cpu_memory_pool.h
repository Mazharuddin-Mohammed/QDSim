#pragma once
/**
 * @file cpu_memory_pool.h
 * @brief Defines the CPUMemoryPool class for efficient CPU memory management.
 *
 * This file contains the declaration of the CPUMemoryPool class, which provides
...
/**
 * @class CPUMemoryPool
 * @brief Provides efficient memory management for CPU operations.
 *
 * The CPUMemoryPool class provides efficient memory management for CPU operations
...
public:
    /**
     * @brief Gets the singleton instance of the CPUMemoryPool.
     *
     * @return The singleton instance of the CPUMemoryPool
     */
...
private:
    /**
     * @brief Constructs a new CPUMemoryPool object.
     *
    ...
    /**
     * @brief Destructor for the CPUMemoryPool object.
     *
