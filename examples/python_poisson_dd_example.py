"""
Example script for the Python implementation of the FullPoissonDriftDiffusionSolver.
...
def plot_results(solver, mesh, bias_voltage=0.0):
    ...
    # Save the figure
    plt.savefig(f'python_pn_junction_bias_{bias_voltage:.1f}.png')
    plt.close()
...
def main():
    ...
    for bias in bias_voltages:
        ...
        print(f"Results saved to python_pn_junction_bias_{bias:.1f}.png")
