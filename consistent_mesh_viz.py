#!/usr/bin/env python3
"""
Consistent mesh and potential visualization for the deep QD simulation.
Ensures all plots use the same coordinate system and dimensions.
"""
...
os.makedirs('results_consistent', exist_ok=True)
...
# Define domain limits based on actual mesh coordinates
...
print(f"Actual mesh domain limits: x=[{x_min_nm:.1f}, {x_max_nm:.1f}] nm, y=[{y_min_nm:.1f}, {y_max_nm:.1f}] nm")
...
# Run simulation for zero bias with more states
print("Simulating with consistent mesh visualization...")
config.V_r = 0.0  # Zero bias
# We already have the simulator from above, just run it again for more states
...
fig_potentials.savefig('results_consistent/potentials_and_mesh.png', dpi=300, bbox_inches='tight')
...
fig_regions.savefig('results_consistent/mesh_regions.png', dpi=300, bbox_inches='tight')
...
fig_wavefunctions.savefig('results_consistent/wavefunctions.png', dpi=300, bbox_inches='tight')
...
fig_slices.savefig('results_consistent/potential_wavefunction_slices.png', dpi=300, bbox_inches='tight')

print("Consistent mesh visualizations saved to 'results_consistent' directory.")
