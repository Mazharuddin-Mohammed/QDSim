...
class TestAnalyticalSolutions:
    ...
    def setup_method(self):
        ...
        self.config.nx = 101     # Mesh points
        self.config.ny = 101     # Mesh points
    ...
    def test_infinite_square_well_2d(self):
        ...
        # Assert that the relative error is small (less than 5%)
        assert np.all(rel_error < 0.05), "Relative error too large"
    ...
    def test_hydrogen_like_atom_2d(self):
        ...
        # Assert that the relative error is small (less than 10% for hydrogen-like atom)
        # This is a more challenging case due to the singularity in the potential
        assert np.all(rel_error < 0.1), "Relative error too large"
