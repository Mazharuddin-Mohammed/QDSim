...
# Import only the qdsim_cpp module
import qdsim.qdsim_cpp as cpp
...
def main():
    ...
    sc_solver = cpp.SelfConsistentSolver(mesh, epsilon_r, rho, n_conc, p_conc, mu_n, mu_p)
